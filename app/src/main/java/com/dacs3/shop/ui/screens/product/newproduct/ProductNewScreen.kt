...
@Composable
fun ProductNewScreen(navController: NavHostController, productNewViewModel: ProductNewViewModel = hiltViewModel()) {
    val uiState by productNewViewModel.uiState.collectAsState()

    LaunchedEffect(Unit) {
        productNewViewModel.loadProduct()
    }
